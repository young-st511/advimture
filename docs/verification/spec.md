...
- command memory UI E2E는 tutorial `기억할 명령`, duplicate coach suppression, incident hint/failure 후 `참고 명령`을 화면과 app_state evidence로 검증한다.
