...
| 5 | INCIDENT-007 | active | search, text object, substitute, visual-line, char-find 조합 mixed run 확장 |
| 6 | PLAYTEST-REVIEW-002 | planned | RedTeam/UX/evidence 점검과 다음 후보 정리 |
...
| INCIDENT-007 | CHOICE-PLAY-003 완료 | mixed recovery run | focused E2E, `make e2e-playable` | 너무 많은 command를 한 beat에 몰아넣지 않음 |
| PLAYTEST-REVIEW-002 | INCIDENT-007 완료 | review report, next candidate | full test/evidence review | 부족한 E2E 발견 시 보강을 우선 |
