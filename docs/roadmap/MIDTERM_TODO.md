...
| 3 | PLAYTEST-EVIDENCE-001 | active | FTUE, incident, command-choice 대표 루트 evidence 점검 |
| 4 | HUD-DENSITY-001 | planned | Mission HUD와 daily/review line의 밀도/줄바꿈 polish |
...
| PLAYTEST-EVIDENCE-001 | action copy 정리 완료 | representative final/timeline evidence review | focused E2E evidence | UX 주관 판단을 evidence 없이 문서화하지 않음 |
