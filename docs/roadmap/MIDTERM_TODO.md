...
| 4 | CHOICE-PLAY-003 | active | quote value reuse-choice playable 구현 |
| 5 | INCIDENT-007 | planned | search, text object, substitute, visual-line, char-find 조합 mixed run 확장 |
...
| CHOICE-PLAY-003 | REUSE-CHOICE-001 완료 | reuse-choice playable beat, scenario, E2E | content replay, focused E2E | 직접 재입력 우회를 constraints로 막음 |
