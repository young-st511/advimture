...
| 2 | INCIDENT-006 | active | `/target` + `ct,` inline target repair incident 구현 |
| 3 | REUSE-CHOICE-001 | planned | `yi"`, `yy/p`, `.`, retype 사이의 재사용 판단 드릴 설계 |
...
| INCIDENT-006 | PLAN-REFRESH-008 완료 | applied incident YAML, scenario, playlist, focused E2E | content replay, focused E2E, full regression | 새 engine 없이 `/`, `ct,` 조합만 사용 |
