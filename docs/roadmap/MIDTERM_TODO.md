...
| 3 | PLAYPACK-012 | active | 4~6문항 char-find-line tutorial content/E2E 구현 |
| 4 | CHAR-FIND-APPLIED-001 | planned | command-choice 또는 incident에 inline target motion 적용 후보 설계 |
...
| PLAYPACK-012 | VIM-030 완료 | char-find-line tutorial YAML, scenario, playlist, focused E2E | content replay, full playlist E2E, `make e2e-playable` | 8문항 이하, required key와 forbidden 우회를 고정 |
| CHAR-FIND-APPLIED-001 | PLAYPACK-012 완료 | applied incident 또는 command-choice 후보 | docs review | 새 engine 기능을 추가하지 않고 적용만 다룸 |
