...
| 2 | VIM-030 | active | char-find pending state, normal motion, delete/change operator 결합 구현 |
| 3 | PLAYPACK-012 | planned | 4~6문항 char-find-line tutorial content/E2E 구현 |
...
| VIM-030 | CHAR-FIND-GAP-001 완료 | `f/t`, `df/dt/cf/ct` engine/runtime/tuiadapter tests | vimengine/tuiadapter/runtime tests, `go test ./...` | engine과 content/E2E를 섞지 않음 |
