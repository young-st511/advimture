...
| 3 | REUSE-CHOICE-001 | active | `yi"`, `yy/p`, `.`, retype 사이의 재사용 판단 드릴 설계 |
| 4 | CHOICE-PLAY-003 | planned | reuse-choice playable 구현 |
...
| REUSE-CHOICE-001 | INCIDENT-006 완료 | reuse-choice drill 후보와 선택 기준 | docs review | 구현 전 범위와 우회 방지 기준을 먼저 고정 |
