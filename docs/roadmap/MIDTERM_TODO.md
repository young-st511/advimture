...
| 6 | CHOICE-JUDGMENT-001 | active | command-choice를 key 암기가 아니라 선택 판단 훈련으로 보강 |
| 7 | SUCCESS-MODAL-001 | planned | success modal heading과 record density 정리 |
...
| CHOICE-JUDGMENT-001 | command-choice가 암기처럼 보일 리스크 확인 | 선택 이유 중심 copy와 E2E assertion | content/playable tests, focused E2E | 새 schema/engine 없이 기존 command 선택 판단만 다룸 |
